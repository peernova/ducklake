-- Worker 4: Update row id=4 multiple times
...
SELECT 'W4: Updating row id=4...';
UPDATE counter SET value = value + 10, updated_by = 'worker4' WHERE id = 4;
UPDATE counter SET value = value + 10 WHERE id = 4;
UPDATE counter SET value = value + 10 WHERE id = 4;
UPDATE counter SET value = value + 10 WHERE id = 4;
UPDATE counter SET value = value + 10 WHERE id = 4;
SELECT 'W4: Done - added 50 to row 4';
